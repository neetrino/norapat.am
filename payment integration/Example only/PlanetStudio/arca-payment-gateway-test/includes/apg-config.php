...
<div class="wrap apg" id="apg-config">
	...
	<div class="mode-switcher">
		...
		<span class="actions">
			...
			<input disabled readonly class="submitLink button-primary" type="button" value="<?php esc_html_e("Switch", 'arca-payment-gateway' ) ?>">
			<a href="https://store.planetstudio.am/product/arca-payment-gateway-pro/" target="_blank" class="upgrade-to-pro"><?php esc_html_e("Upgrade to PRO", 'arca-payment-gateway' ) ?></a>
		</span>
	</div>
