...
export function BrandBannerSection() {
  ...
  return (
    <section
      className="brand-banner-section brand-banner-fullscreen promo-food-banner-bg brand-banner-bg-dark promo-food-banner-vignette relative overflow-hidden text-white"
      aria-label={homeAria}
    >
      <div className="mx-auto flex min-h-full w-full max-w-7xl items-center px-4 sm:px-6 lg:px-8">
        <div className="relative z-10 w-full py-8 sm:py-10 lg:py-12">
          <div className="grid min-h-full grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-6 xl:gap-10">
