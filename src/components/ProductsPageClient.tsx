...
interface ProductsPageClientProps {
  ...
  initialTotalProductCount?: number
  initialSearchQuery?: string
  initialSelectedCategoryName?: string | null
  initialMenuPage?: number
}
...
function ProductsPageContent({
  ...
  initialSearchQuery = '',
  initialSelectedCategoryName = null,
  initialMenuPage = 1,
  ...
  const [categoriesLoading, setCategoriesLoading] = useState(initialCategories === undefined)
  ...
  const [totalProductCount, setTotalProductCount] = useState(initialTotalProductCount ?? 0)
  ...
  const skipInitialProductsFetchRef = useRef(
    initialProducts !== undefined && initialTotalProductCount !== undefined
  )
  ...
  useEffect(() => {
    ...
    const nextCategoryName = searchParams.get('category')
    ...
    setSelectedCategoryName((current) => (current === nextCategoryName ? current : nextCategoryName))
  }, [searchParams])
    ...
    <div className="min-h-screen bg-[#fcfaf7] text-slate-900">
      ...
      <div className="mx-auto flex max-w-7xl gap-6 px-4 pb-6 pt-4 sm:px-6 sm:pt-5 lg:px-8 lg:gap-8 lg:pt-6">
        ...
        <main className="min-w-0 flex-1 pb-20 pt-1 lg:pb-8">
          ...
          <section className="mb-5 hidden overflow-hidden rounded-[2rem] border border-[#eadfd9] bg-white/90 shadow-[0_16px_40px_rgba(15,23,42,0.05)] backdrop-blur sm:block">
                ...
                <div className="flex flex-wrap items-center gap-2.5">
                  ...
                  <div className="flex items-center gap-2 rounded-2xl border border-[#eadfd9] bg-[#fcfaf8] p-1.5 shadow-sm">
                    <input
                      ...
                      min={0}
                      step={100}
                      className="w-[127px] rounded-xl border border-transparent bg-white px-3 py-2.5 text-xs font-medium text-slate-700 placeholder:text-slate-400 focus:border-[#E53225] focus:outline-none focus:ring-2 focus:ring-[#E53225]/10 md:w-24"
                    />
                    ...
                    <input
                      ...
                      min={0}
                      step={100}
                      className="w-[120px] rounded-xl border border-transparent bg-white px-3 py-2.5 text-xs font-medium text-slate-700 placeholder:text-slate-400 focus:border-[#E53225] focus:outline-none focus:ring-2 focus:ring-[#E53225]/10 md:w-24"
                    />
