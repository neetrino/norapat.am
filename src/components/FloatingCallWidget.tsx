    ...
    >
      <div className="relative pointer-events-auto">
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-full border border-[#f7a29c]/70 bg-[radial-gradient(circle_at_30%_30%,#ff7469_0%,#ee3124_48%,#a81f16_100%)] text-white shadow-[0_12px_28px_rgba(238,49,36,0.34)] ring-1 ring-white/12 transition-[box-shadow] duration-200 hover:shadow-[0_16px_34px_rgba(238,49,36,0.42)] focus-visible:outline-none sm:h-12 sm:w-12"
        >
