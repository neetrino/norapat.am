...
export const hy: AppMessages = {
  ...
  home: {
    ...
    testimonial2Quote:
      '«Լավագույն պիդեները Արմավիրում։ Որակը գերազանց է, գները հարմար։ Հատկապես դուր է գալիս մսային պիդեն սոուսով։»',
  ...
  contactPage: {
    ...
    testimonial2Quote:
      '«Լավագույն խաչապուրին Արմավիրում։ Կծու խաչապուրին անհավատալի է։ Խորհուրդ եմ տալիս բոլորին։»',
